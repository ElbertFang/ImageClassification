...
def load_data(path):
    ...
    for imagePath in imagePaths:
        ...
        image = cv2.imread(imagePath, cv2.COLOR)
...
def train(aug,trainX,trainY,testX,testY):
    ...
    base_model = InceptionV3(weights='imagenet', include_top=False, classes=CLASS_NUM)
    output = base_model.output
    output = GlobalAveragePooling2D()(output)
    output = Dense(5031, activation='relu')(output)
